      ...
      <Container>
        <div className="mx-auto max-w-lg border border-stone-300 bg-white p-7 sm:p-10">
          ...
          <form action={signIn} className="mt-7 space-y-4">
            ...
            <div><label className="mb-1.5 block text-sm font-medium text-stone-700">Password</label><input name="password" type="password" required className={inputBase} placeholder="Your password" /></div>
